...
const tempSegments = [
  { icon: '🥶', text: `선선함 (${MILD_THRESHOLD}℃↓)`, color: NEUTRAL_LOW },
  { icon: '🙂', text: `보통 (${MILD_THRESHOLD}~${HOT_THRESHOLD - 1}℃)`, color: NEUTRAL_MID },
  { icon: '🥵', text: `더움 (${HOT_THRESHOLD}℃↑)`, color: 'rgba(231, 76, 60, 0.18)' },
]
